...
(let ((colors '(;; Upstream theme color
                (catppuccin-bg      "#1e1e2e" "unspecified-bg" "unspecified-bg") ; official background (Base)
                (catppuccin-fg      "#cdd6f4" "#f5e0dc" "brightwhite")   ; official foreground (Text, rosewater)
                (catppuccin-current "#585b70" "#45475a" "brightblack")   ; official current-line/selection (surface2, surface1)
                (catppuccin-comment "#6c7086" "#89b4fa" "blue")          ; official comment (overlay0, Blue)
                (catppuccin-cyan    "#74c7ec" "#89dceb" "brightcyan")    ; official cyan (Sapphire, sky)
                (catppuccin-green   "#94e2d5" "#a6e3a1" "green")         ; official green (Teal, Green)
                (catppuccin-orange  "#eba0ac" "#fab387" "brightred")     ; official orange (Maroon, Peach)
                (catppuccin-pink    "#f5c2e7" "#cba6f7" "magenta")       ; official pink (Pink, Mauve)
                (catppuccin-purple  "#b4befe" "#cba6f7" "brightmagenta") ; official purple (Lavender, Mauve)
                (catppuccin-red     "#eba0ac" "#f38ba8" "red")           ; official red (Maroon, Red)
                (catppuccin-yellow  "#f9e2af" "#f9e2af" "yellow")        ; official yellow (Yellow, Yellow)
                ;; Other colors
                (bg2             "#1e1e2e" "#11111b" "brightblack")  ; (Base, Crust)
                (bg3             "#1e1e2e" "#313244" "brightblack")  ; (Base, Surface0)
                (bg4             "#1e1e2e" "#45475a" "brightblack")  ; (Base, Surface1)
                (fg2             "#bac2de" "#cdd6f4" "brightwhite")  ; (Subtext1, Text)
                (fg3             "#a6adc8" "#9399b2" "white")        ; (Subtext0, Overlay2)
                (fg4             "#6c7086" "#7f849c" "white") 		 ; (Overlay0, Overlay1)
                (other-blue      "#89b4fa" "#74c7ec" "brightblue"))) ; (Sky, Sapphire)
      (faces '(;; default / basic faces
               ...
               (magit-diff-added :background "#a6e3a1" ; (Greem)
                                 :foreground "#94e2d5" ; (Teal)
                                 :extend t)
               (magit-diff-added-highlight :background "#a6e3a1"  ; (Green)
                                           :foreground "#94e2d5" ; (Teal)
                                           :extend t)
               (magit-diff-removed :background "#f38ba8" ; (Red)
                                   :foreground "#eba0ac" ; (Maroon)
                                   :extend t)
               (magit-diff-removed-highlight :background "#f38ba8" ; (Red)
                                             :foreground "#eba0ac" ; (Maroon)
                                             :extend t)
