...
(let ((colors '(;; Upstream theme color
                (catppuccin-bg      "#eff1f5" "unspecified-bg" "unspecified-bg") ; official background (Base)
                (catppuccin-fg      "#4c4f69" "#dc8a78" "brightwhite")   ; official foreground (Text, rosewater)
                (catppuccin-current "#acb0be" "#bcc0cc" "brightblack")   ; official current-line/selection (surface2, surface1)
                (catppuccin-comment "#9ca0b0" "#1e66f5" "blue")          ; official comment (overlay0, Blue)
                (catppuccin-cyan    "#209fb5" "#04a5e5" "brightcyan")    ; official cyan (Sapphire, sky)
                (catppuccin-green   "#179299" "#40a02b" "green")         ; official green (Teal, Green)
                (catppuccin-orange  "#e64553" "#fe640b" "brightred")     ; official orange (Maroon, Peach)
                (catppuccin-pink    "#ea76cb" "#8839ef" "magenta")       ; official pink (Pink, Mauve)
                (catppuccin-purple  "#7287fd" "#8839ef" "brightmagenta") ; official purple (Lavender, Mauve)
                (catppuccin-red     "#e64553" "#d20f39" "red")           ; official red (Maroon, Red)
                (catppuccin-yellow  "#df8e1d" "#df8e1d" "yellow")        ; official yellow (Yellow, Yellow)
                ;; Other colors
                (bg2             "#eff1f5" "#dce0e8" "brightblack")  ; (Base, Crust)
                (bg3             "#eff1f5" "#ccd0da" "brightblack")  ; (Base, Surface0)
                (bg4             "#eff1f5" "#bcc0cc" "brightblack")  ; (Base, Surface1)
                (fg2             "#5c5f77" "#4c4f69" "brightwhite")  ; (Subtext1, Text)
                (fg3             "#6c6f85" "#7c7f93" "white")        ; (Subtext0, Overlay2)
                (fg4             "#9ca0b0" "#8c8fa1" "white") 		 ; (Overlay0, Overlay1)
                (other-blue      "#04a5e5" "#209fb5" "brightblue"))) ; (Sky, Sapphire)
      (faces '(;; default / basic faces
               ...
               (magit-diff-added :background "#40a02b" ; (Greem)
                                 :foreground "#179299" ; (Teal)
                                 :extend t)
               (magit-diff-added-highlight :background "#40a02b"  ; (Green)
                                           :foreground "#179299" ; (Teal)
                                           :extend t)
               (magit-diff-removed :background "#d20f39" ; (Red)
                                   :foreground "#e64553" ; (Maroon)
                                   :extend t)
               (magit-diff-removed-highlight :background "#d20f39" ; (Red)
                                             :foreground "#e64553" ; (Maroon)
                                             :extend t)
