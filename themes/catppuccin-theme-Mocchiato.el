...
;; Name: Ello anytime you see "Name: " its me adding to the source material
;; Name: I have kinda eyeballed the colours in this so anything weird you notice send me a message and I'll fix it
...
(let ((colors '(;; Upstream theme color
                (catppuccin-bg      "#24273a" "unspecified-bg" "unspecified-bg") ; official background (Base)
                (catppuccin-fg      "#cad3f5" "#f4dbd6" "brightwhite")   ; official foreground (Text, rosewater)
                (catppuccin-current "#5b6078" "#494d64" "brightblack")   ; official current-line/selection (surface2, surface1)
                (catppuccin-comment "#6e738d" "#8aadf4" "blue")          ; official comment (overlay0, Blue)
                (catppuccin-cyan    "#7dc4e4" "#91d7e3" "brightcyan")    ; official cyan (Sapphire, sky)
                (catppuccin-green   "#8bd5ca" "#a6da95" "green")         ; official green (Teal, Green)
                (catppuccin-orange  "#ee99a0" "#f5a97f" "brightred")     ; official orange (Maroon, Peach)
                (catppuccin-pink    "#f5bde6" "#c6a0f6" "magenta")       ; official pink (Pink, Mauve)
                (catppuccin-purple  "#b7bdf8" "#c6a0f6" "brightmagenta") ; official purple (Lavender, Mauve)
                (catppuccin-red     "#ee99a0" "#ed8796" "red")           ; official red (Maroon, Red)
                (catppuccin-yellow  "#eed49f" "#eed49f" "yellow")        ; official yellow (Yellow, Yellow)
                ;; Other colors
                (bg2             "#24273a" "#181926" "brightblack")  ; (Base, Crust)
                (bg3             "#24273a" "#363a4f" "brightblack")  ; (Base, Surface0)
                (bg4             "#24273a" "#494d64" "brightblack")  ; (Base, Surface1)
                (fg2             "#b8c0e0" "#cad3f5" "brightwhite")  ; (Subtext1, Text)
                (fg3             "#a5adcb" "#939ab7" "white")        ; (Subtext0, Overlay2)
                (fg4             "#6e738d" "#8087a2" "white") 		 ; (Overlay0, Overlay1)
                (other-blue      "#91d7e3" "#7dc4e4" "brightblue"))) ; (Sky, Sapphire)
      (faces '(;; default / basic faces
               ...
               (magit-diff-added :background "#a6da95" ; (Green)
                                 :foreground "#8bd5ca" ; (Teal)
                                 :extend t)
               (magit-diff-added-highlight :background "#a6da95"  ; (Green)
                                           :foreground "#8bd5ca" ; (Teal)
                                           :extend t)
               (magit-diff-removed :background "#ed8796" ; (Red)
                                   :foreground "#ee99a0" ; (Maroon)
                                   :extend t)
               (magit-diff-removed-highlight :background "#ed8796" ; (Red)
                                             :foreground "#ee99a0" ; (Maroon)
                                             :extend t)
