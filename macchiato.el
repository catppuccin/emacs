...
(let ((colors '(;; Upstream theme color
                (catppuccin-bg      "#24273a" "unspecified-bg" "unspecified-bg") ; official background
                (catppuccin-fg      "#cad3f5" "#ffffff" "brightwhite") ; official foreground
                ...
                (catppuccin-cyan    "#91d7e3" "#87d7ff" "brightcyan")  ; official cyan
                (catppuccin-green   "#a6da95" "#5fff87" "green")       ; official green
                (catppuccin-orange  "#ed8796" "#ffaf5f" "brightred")   ; official orange
                (catppuccin-pink    "#f5bde6" "#ff87d7" "magenta")     ; official pink
                (catppuccin-purple  "#bd93f9" "#af87ff" "brightmagenta") ; official purple
                (catppuccin-red     "#ed8796" "#ff8787" "red")         ; official red
                (catppuccin-yellow  "#eed49f" "#ffff87" "yellow")      ; official yellow
                ;; Other colors
                ...
                (other-blue      "#8aadf4" "#0087ff" "brightblue")))
