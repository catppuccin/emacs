...
(let ((colors '(;; Upstream theme color
                (catppuccin-bg      "#eff1f5" "unspecified-bg" "unspecified-bg") ; official background
                (catppuccin-fg      "#4c4f69" "#ffffff" "brightwhite") ; official foreground
                ...
                (catppuccin-cyan    "#04a5e5" "#87d7ff" "brightcyan")  ; official cyan
                (catppuccin-green   "#40a02b" "#5fff87" "green")       ; official green
                (catppuccin-orange  "#d20f39" "#ffaf5f" "brightred")   ; official orange
                (catppuccin-pink    "#ea76cb" "#ff87d7" "magenta")     ; official pink
                (catppuccin-purple  "#bd93f9" "#af87ff" "brightmagenta") ; official purple
                (catppuccin-red     "#d20f39" "#ff8787" "red")         ; official red
                (catppuccin-yellow  "#df8e1d" "#ffff87" "yellow")      ; official yellow
                ;; Other colors
                ...
                (other-blue      "#1e66f5" "#0087ff" "brightblue")))
