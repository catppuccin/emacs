;;; doom-catppuccin-theme.el - based on https://catppuccintheme.com/ -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
(defcustom doom-catppuccin-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Catppuccin Emacs theme."
  :group 'doom-catppuccin-theme
  :type 'boolean)

(defcustom doom-catppuccin-comment-bg doom-dracula-brighter-comments
...
(def-doom-theme doom-catppuccin
  "A dark theme based on Catppuccin theme"

  ;; name        default   256       16
  ((bg         '("#1e1e38" "#262626" "black"        ))
   (bg-alt     '("#1E2029" "#1c1c1c" "black"        ))
   (base0      '("#6e6c7e" "#1c1c1c" "black"        ))
   (base1      '("#e38c8f" "#1e1e1e" "brightblack"  ))
   (base2      '("#b1e3ad" "#2e2e2e" "brightblack"  ))
   (base3      '("#ebddaa" "#262626" "brightblack"  ))
   (base4      '("#a4b9ef" "#3f3f3f" "brightblack"  ))
   (base5      '("#c6aae8" "#525252" "brightblack"  ))
   (base6      '("#e5b4e2" "#bbbbbb" "brightblack"  ))
   (base7      '("#dadae8" "#cccccc" "brightblack"  ))
   (base8      '("#6e6c7e" "#dfdfdf" "white"        ))
   (fg         '("#dadae8" "#ffffff" "white"        ))
   (fg-alt     '("#e2e2dc" "#bfbfbf" "brightwhite"  ))

   (grey       base4)
   (red        '("#e38c8f" "#ff6655" "red"          ))
   (orange     '("#ffb86c" "#ffbb66" "brightred"    ))
   (green      '("#b1e3ad" "#55ff77" "green"        ))
   (teal       '("#0189cc" "#0088cc" "brightgreen"  ))
   (yellow     '("#ebddaa" "#ffff88" "yellow"       ))
   (blue       '("#a4b9ef" "#66bbff" "brightblue"   ))
   (dark-blue  '("#0189cc" "#0088cc" "blue"         ))
   (magenta    '("#c6aae8" "#ff77cc" "magenta"      ))
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if doom-catppuccin-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if doom-catppuccin-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if doom-catppuccin-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if doom-catppuccin-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if doom-catppuccin-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if doom-catppuccin-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if doom-catppuccin-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright doom-catppuccin-brighter-modeline)
   (-modeline-pad
    (when doom-catppuccin-padded-modeline
      (if (integerp doom-catppuccin-padded-modeline) doom-dracula-padded-modeline 4)))
