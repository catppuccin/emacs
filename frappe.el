...
(let ((colors '(;; Upstream theme color
                (catppuccin-bg      "#303446" "unspecified-bg" "unspecified-bg") ; official background
                (catppuccin-fg      "#c6d0f5" "#ffffff" "brightwhite") ; official foreground
                ...
                (catppuccin-cyan    "#99d1db" "#87d7ff" "brightcyan")  ; official cyan
                (catppuccin-green   "#a6d189" "#5fff87" "green")       ; official green
                (catppuccin-orange  "#e78284" "#ffaf5f" "brightred")   ; official orange
                (catppuccin-pink    "#f4b8e4" "#ff87d7" "magenta")     ; official pink
                (catppuccin-purple  "#bd93f9" "#af87ff" "brightmagenta") ; official purple
                (catppuccin-red     "#e78284" "#ff8787" "red")         ; official red
                (catppuccin-yellow  "#e5c890" "#ffff87" "yellow")      ; official yellow
                ;; Other colors
                ...
                (other-blue      "#8caaee" "#0087ff" "brightblue")))
