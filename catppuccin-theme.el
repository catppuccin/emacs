...
(let ((colors '((undef     "#ff00ff" "#ff00ff")
      ...
      (faces '(;; default / basic faces
               ...
               (erc-error-face :foreground ,ctp-red :weight bold)
               ...
               (erc-keyword-face :foreground ,ctp-lavender :weight bold)
               (erc-my-nick-face :foreground ,ctp-lavender :weight bold)
               (erc-my-nick-prefix-face :foreground ,ctp-lavender :weight bold)
               (erc-nick-default-face :foreground ,ctp-blue :weight bold)
               (erc-nick-prefix-face :foreground ,ctp-blue :weight bold)
               (erc-nick-msg-face :foreground ,ctp-yellow :weight bold)
               (erc-notice-face :foreground ,ctp-subtext0 :slant italic)
               (erc-pal-face :foreground ,ctp-pink :weight bold)
               (erc-prompt-face :foreground ,ctp-blue :weight bold)
