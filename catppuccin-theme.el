...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default / basic faces
               ...
               (org-ref-acronym-face :foreground ,catppuccin-orange)
               (org-ref-bad-cite-key-face :foreground ,catppuccin-red)
               (org-ref-cite-invalid-local-prefix/suffix-face :foreground ,catppuccin-red)
               (org-ref-cite-face :foreground ,catppuccin-green)
               (org-ref-cite-&-face :foreground ,catppuccin-green)
               (org-ref-cite-global-prefix/suffix-face :foreground ,catppuccin-green)
               (org-ref-cite-local-prefix/suffix-face :foreground ,catppuccin-green)
               (org-ref-glossary-face :foreground ,catppuccin-purple)
               (org-ref-label-face :foreground ,catppuccin-purple)
               (org-ref-ref-face :foreground ,catppuccin-pink)
